// Standard CRA 5 service worker registration helper.
// Registers the service worker in production; unregisters in development.
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.log('[PWA] Serving from cache via service worker (localhost).');
        });
      } else {
